...
check_token() {
  ...
  if [ "$USER_TOKEN" = "rizky123" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy Token Dulu Di Rizky Hosting${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/RizkyHosting/ThemaRiz/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/RizkyHosting/ThemaRiz/raw/main/C3.zip")
        break
        ;; 
      x)
        return
